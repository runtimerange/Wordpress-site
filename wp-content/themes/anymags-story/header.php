...
<div id="page" class="site">
    <a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e( 'Skip to content', 'anymags-story' ); ?></a>
<?php
...
?>
    ...
    <header class="wp-header">
        ...
        <div class="navbar-area <?php echo esc_attr($anymags_nav_class);?>">
            ...
            <div class="main-nav">
                    <nav id="site-navigation" class="anymags-main-navigation" role="navigation" aria-label="<?php esc_html__('Primary', 'anymags-story')?>">
                        <div class="wrapper">
                             <?php
                            ...
                            wp_nav_menu( array(
                                ...
                                echo '<a href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '" class="nav-link" title="' . esc_attr__( 'Add a menu', 'anymags-story' ) . '">' . esc_html__( 'Add A Menu', 'anymags-story' ) . '</a>';
                            }
                            ?>
                        </div><!-- .wrapper -->
                    </nav><!-- #site-navigation -->
